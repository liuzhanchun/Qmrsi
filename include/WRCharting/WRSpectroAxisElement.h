#pragma once
#ifndef WRSPECTROAXISELEMENT
#define WRSPECTROAXISELEMENT
...
//表示频谱图横向坐标轴元素。
class WRCHARTING_CLASS WRSpectroHAxisElement : public WRChartHAxisElement
{
    Q_OBJECT
...
//表示频谱图纵向坐标轴元素。
class WRCHARTING_CLASS WRSpectroVAxisElement : public WRChartVAxisElement
{
    Q_OBJECT
