#pragma once
#ifndef WRWATERFALLAXISELEMENT
#define WRWATERFALLAXISELEMENT
...
//表示瀑布图横向坐标轴元素。
class WRCHARTING_CLASS WRWaterfallHAxisElement : public WRChartHAxisElement
{
    Q_OBJECT
...
//表示瀑布图纵向坐标轴元素。
class WRCHARTING_CLASS WRWaterfallVAxisElement : public WRChartVAxisElement
{
    Q_OBJECT
