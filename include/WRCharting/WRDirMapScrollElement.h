#pragma once
#ifndef WRDIRMAPSCROLLELEMENT
#define WRDIRMAPSCROLLELEMENT
...
//表示向频图横向坐标轴元素。
class WRCHARTING_CLASS WRDirMapHScrollElement : public WRChartHScrollElement
{
    Q_OBJECT
...
//表示向频图纵向坐标轴元素。
class WRCHARTING_CLASS WRDirMapVScrollElement : public WRChartVScrollElement
{
    Q_OBJECT
